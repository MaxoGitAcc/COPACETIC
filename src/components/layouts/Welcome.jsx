export default function Welcome(props) {
    ...
    return (
        <section id="welcome">
            ...
            <h6>Build your lexicon <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24" strokeWidth="1.5" stroke="rgb(219 234 254)"
                className="size-6"><path strokeLinecap="round" strokeLinejoin="round"
